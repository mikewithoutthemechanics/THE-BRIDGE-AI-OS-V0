...
beforeAll(async () => {
  ...
  systemProc = spawn(
    ...
    {
      env: { ...process.env, PORT: String(systemPort), NODE_ENV: 'test' },
...
describe('system.js GET /api/full', () => {
  test('returns 200', async () => {
    const res = await httpGet(systemPort, '/api/full');
    expect(res.status).toBe(200);
  });
...
describe('system.js GET /api/scan', () => {
  test('returns 200', async () => {
    const res = await httpGet(systemPort, '/api/scan');
    expect(res.status).toBe(200);
  });
...
describe('system.js GET /api/engines', () => {
  test('returns 200', async () => {
    const res = await httpGet(systemPort, '/api/engines');
    expect(res.status).toBe(200);
  });
...
describe('system.js GET /api/economic', () => {
  test('returns 200', async () => {
    const res = await httpGet(systemPort, '/api/economic');
    expect(res.status).toBe(200);
  });
...
describe('system.js GET /api/recommendations', () => {
  test('returns 200', async () => {
    const res = await httpGet(systemPort, '/api/recommendations');
    expect(res.status).toBe(200);
  });
...
describe('system.js GET /api/logs', () => {
  test('returns 200', async () => {
    const res = await httpGet(systemPort, '/api/logs');
    expect(res.status).toBe(200);
  });
...
describe('system.js GET /api/metrics', () => {
  test('returns 200', async () => {
    const res = await httpGet(systemPort, '/api/metrics');
    expect(res.status).toBe(200);
  });
