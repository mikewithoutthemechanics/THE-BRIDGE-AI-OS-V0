...
(function () {
  ...
  var ROUTES = [
    ...
    { label: 'Bridge Home',    href: '/bridge-home',     role: null },
    ...
    { label: 'Activation',     href: '/activation',     role: null },
    ...
    { label: 'eSIM PBX',     href: '/esim-pbx',      role: 'user' },
    ...
    { label: 'Legal AI',      href: '/legal-ai',      role: 'user' },
    ...
    { label: 'Withdrawals',     href: '/admin-withdraw', role: 'admin' },
    ...
    { label: 'Supadash Registry', href: '/supadash-registry', role: 'admin' },
    { label: 'Supadash Topology', href: '/supadash-topology', role: 'admin' },
    { label: 'Supadash Marketplace', href: '/supadash-marketplace', role: 'admin' },
    { label: 'Supadash Avatar', href: '/supadash-avatar', role: 'admin' },
