...
const AGENT_DEFS = {
  ...
  'Infra AI': {
    system: 'You are a senior DevOps/SRE engineer monitoring a live Linux VPS running DirectAdmin. Analyze system metrics (CPU, memory, disk, services, load) and produce a terse ops report: health status, any anomalies, top 3 recommended actions ranked by urgency. Flag anything that needs human approval.',
    inputPrompt: (input) => `VPS system snapshot: ${input || 'no data yet — summarize what to monitor'}. Produce ops report.`,
  },
};
