...
function mount(app) {
  ...
  app.get('/api/registry/agents', async function(req, res) {
    try {
      var filter = {};
  ...
  // ─── Search agents ────────────────────────────────────────────────────
  app.get('/api/registry/search', async function(req, res) {
  ...
  // ─── Bulk import ──────────────────────────────────────────────────────
  app.post('/api/registry/import', async function(req, res) {
