...
// External hooks — injected by brain.js or other modules
let _getNetRevenue = () => 0;
let _getAgentPerformance = () => [];
let _creditAgent = (_agentId, _amount, _reason) => {};
let _addToTreasury = (_amount) => {};
let _burnTokens = (_amount) => {};
