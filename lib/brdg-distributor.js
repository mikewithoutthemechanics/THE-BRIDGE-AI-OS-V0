...
async function distributeReward(toAddress, rewardType, multiplier = 1) {
  ...
  if (!hasSecret) {
    console.warn('[brdg-distributor] no treasury key configured — skipping on-chain distribution');
...
module.exports = { distributeReward, getTreasuryBalance, batchDistribute, REWARD_RATES };
